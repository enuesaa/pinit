...
func (aq *ActionQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (aq *ActionQuery) FirstIDX(ctx context.Context) uint {
...
func (aq *ActionQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (aq *ActionQuery) OnlyIDX(ctx context.Context) uint {
...
func (aq *ActionQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (aq *ActionQuery) IDsX(ctx context.Context) []uint {
	ids, err := aq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (aq *ActionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(action.Table, action.Columns, sqlgraph.NewFieldSpec(action.FieldID, field.TypeUint))
	_spec.From = aq.sql
