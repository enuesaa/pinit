...
// The AppconfFunc type is an adapter to allow the use of ordinary
// function as Appconf mutator.
type AppconfFunc func(context.Context, *ent.AppconfMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AppconfFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AppconfMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AppconfMutation", m)
}

// The BinderFunc type is an adapter to allow the use of ordinary
// function as Binder mutator.
type BinderFunc func(context.Context, *ent.BinderMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f BinderFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.BinderMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.BinderMutation", m)
}
