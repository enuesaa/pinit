...
func (nc *NoteCreate) SetBinderID(u uint) *NoteCreate {
	nc.mutation.SetBinderID(u)
	return nc
}

// SetNillableBinderID sets the "binder_id" field if the given value is not nil.
func (nc *NoteCreate) SetNillableBinderID(u *uint) *NoteCreate {
	if u != nil {
		nc.SetBinderID(*u)
	}
	return nc
...
func (nc *NoteCreate) SetPublisher(s string) *NoteCreate {
	nc.mutation.SetPublisher(s)
	return nc
}

// SetComment sets the "comment" field.
func (nc *NoteCreate) SetComment(s string) *NoteCreate {
	nc.mutation.SetComment(s)
	return nc
}

// SetNillableComment sets the "comment" field if the given value is not nil.
func (nc *NoteCreate) SetNillableComment(s *string) *NoteCreate {
	if s != nil {
		nc.SetComment(*s)
	}
	return nc
...
func (nc *NoteCreate) check() error {
	if _, ok := nc.mutation.Publisher(); !ok {
		return &ValidationError{Name: "publisher", err: errors.New(`ent: missing required field "Note.publisher"`)}
	}
	if v, ok := nc.mutation.Publisher(); ok {
...
func (nc *NoteCreate) createSpec() (*Note, *sqlgraph.CreateSpec) {
	...
	if value, ok := nc.mutation.BinderID(); ok {
		_spec.SetField(note.FieldBinderID, field.TypeUint, value)
		_node.BinderID = value
	}
	if value, ok := nc.mutation.Publisher(); ok {
